...
1. display the types of rooms that the user can book
2. accept the room that the user wants to book
3. all that room booked and its cost to the corresponding user in the booking cycle

:param date_of_travel: the date on which the user is travelling
:return: returns the room that the user has booked and the cost of the room per night
'''


def hotel_room_reservation(date_of_travel):
    ...
    print(f"Your room has been booked on {date_of_travel} from 12:00 noon for 23 hours")
