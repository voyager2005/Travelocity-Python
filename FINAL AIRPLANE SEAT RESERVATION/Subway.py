...
veggies_list = ["Olives", "Jalapenos", "Onion", "baby tomatoes", "lettuce", "tofu",
                "bell peppers"]
veggies_cost = [5, 5, 10, 10, 10, 30, 30]
...
def display_bill():
    ...
    print(f''' {bcolors.HEADER}FOOD BILL AMOUNT{bcolors.ENDC}
    Food Bill Amount: {bcolors.OKCYAN}{cost_of_food}{bcolors.ENDC}
    Food Bill Amount (18% GST): {bcolors.OKCYAN}{cost_of_food * 118/100}{bcolors.ENDC}
    ''')
